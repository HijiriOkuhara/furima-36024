class PurchaseRecordDeliveryArea
  ...
  with_options presence: true do
    ...
    validates :city
    validates :block
    validates :phone_number, format: { with: /\A\d{11,11}\z/, message: 'is too short' },
  ...
  def save
    ...
    DeliveryArea.create(postal_code: postal_code, prefecture_id: prefecture, city: city, block: block,
