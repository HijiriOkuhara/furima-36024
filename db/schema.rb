...
ActiveRecord::Schema.define(version: 2021_09_16_132408) do
  ...
  create_table "delivery_areas", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_record_id"], name: "index_delivery_areas_on_purchase_record_id"
  end
  ...
  add_foreign_key "delivery_areas", "purchase_records"
